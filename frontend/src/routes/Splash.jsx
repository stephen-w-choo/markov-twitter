...
function FancyUnderline({as, colour, children, size, style}) {
  const underlineSvg = (
    <svg
    id="Layer_1"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 260 15.6"
    style={{position: "absolute", top: "70%", left: 0, height: "0.58em", width: "100%", fill: colour, opacity: 0.5}}
    >
  ...
  return (
    <Text as={as} size={size} whiteSpace="nowrap" color={colour} position="relative" style={style}>
      {underlineSvg}
      {children}
    </Text>
  )
    ...
    <Stack spacing='7' alignItems="center">
      ...
      <Flex justifyContent={"space-around"} flexWrap="wrap">
        ...
        >
          ...
          <SplashImage image={languageModelImage}/>
        </Box>
        <Box m={2}
        minW="30ch"
        maxH="40ch"
        ...
        >
          ...
          <SplashImage image={generatedTweetsImage}/>
        </Box>
      </Flex>
      <StackDivider />
